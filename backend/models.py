...
class Order(db.Model):
    ...
    # customer_id = Column(Integer, nullable=False, ForeignKey('customers.id'))  # foreign key
...
class Shipment(db.Model):
    ...
    # order_id = Column(Integer, index=True, nullable=False, ForeignKey('orders.id')) # foreign_key
